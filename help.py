...
class Help:
    def __init__(self, root):
        ...
        title_lbl = Label(self.root,text="HELP",font=("times new roman",25,"bold"),bg="black",fg="white")
        ...
        img_top = Image.open(r".\assets\Help.jpg")
        ...
        email_label1 = Label(f_lbl, text="For any queries, drop a mail ", font=("times new roman", 50, "underline","bold"),fg="white", bg='black')
        email_label1.place(x=350,y=100)
        
        email_label2 = Label(f_lbl, text=" Contact us 📧 ", font=("times new roman", 30, "bold"),fg="blue", bg='black', cursor='hand2')
        email_label2.place(x=650,y=200)
